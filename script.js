const projects = [
  ...
  {
    title: "Лендинг для онлайн-школы AI",
    desc: "Киберпанк-лендинг для курса по работе с искусственным интеллектом. Анимированный терминал, неоновый дизайн, форма заявки.",
